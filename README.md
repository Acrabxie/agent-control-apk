...
- Natural light-gray execution/status stream alongside text output, including running, editing, creating, build/test, model fallback, and context-compaction events.
